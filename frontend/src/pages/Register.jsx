  ...
  return (
    ...
    <div className='bg-white p-8 rounded-lg shadow-lg w-full max-w-md'>
        <div className='flex justify-center mb-4'>
            <img className='h-12' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRS-meG8HDT-iFgfeMdVxdjT_zYLvMVrd8Nw&s" alt="Pinterest" />
        </div>
        <h2 className='text-2xl font-semibold text-center mb-6'>Register to Pinterest</h2>
        <form onSubmit={submitHandler}>
        <div className='mb-4'>
                <label htmlFor='name' className='block text-sm font-medium text-gray-700'>Name</label>
               <input type='text' id='name' className='common-input'
        ...
        <div className='mt-6 text-center'>
            <div className='relative mb-4'>
                ...
                <div className='realtive flex justify-center text-sm'>
                    <span className='bg-white px-2 to-gray-50'>OR</span>
                </div>
            </div>
            <div className='mt-4 text-center text-sm'>
                <span>
                    Already have an account ? <Link to="/login" className='font-medium text-pinterest hover:underline'>Login</Link>
                    </span>
            </div>
        </div>
    </div>
